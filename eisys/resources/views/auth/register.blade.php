...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('お客様情報登録') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="first_name" class="col-md-4 col-form-label text-md-right">{{ __('苗字') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="last_name" class="col-md-4 col-form-label text-md-right">{{ __('名前') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="country" class="col-md-4 col-form-label text-md-right">{{ __('国') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="zip_code" class="col-md-4 col-form-label text-md-right">{{ __('郵便番号') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="state" class="col-md-4 col-form-label text-md-right">{{ __('都道府県') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address1" type="address1" class="form-control @error('address1') is-invalid @enderror" name="address1" required autocomplete="address1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address2" type="address2" class="form-control @error('address2') is-invalid @enderror" name="address2" required autocomplete="address2">
